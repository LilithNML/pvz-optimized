...
###### Plants vs. Zombies: MODDED © 2025 by ROBINET13 & Clay (ClaytonTDM) is licensed under [PolyForm Noncommercial License 1.0.0](https://github.com/Plants-vs-Zombies-MODDED/game/blob/main/LICENSE.md). This license applies only to original code/content created by the modding team. All Plants vs. Zombies intellectual property remains the exclusive property of PopCap Games and Electronic Arts (EA).
